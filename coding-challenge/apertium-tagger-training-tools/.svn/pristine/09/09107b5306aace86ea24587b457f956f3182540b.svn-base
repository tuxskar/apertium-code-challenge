...
TaggerMergingData::getEosTag() {
  return fine2coarse[TaggerData::getTagIndex()[L"TAG_SENT"]];
}

int 
TaggerMergingData::getFineEofTag() {
  return TaggerData::getTagIndex()[L"TAG_kEOF"];
}

int 
TaggerMergingData::getUndefTag() {
  return fine2coarse[TaggerData::getTagIndex()[L"TAG_kUNDEF"]];
}

int 
TaggerMergingData::getFineUndefTag() {
  return TaggerData::getTagIndex()[L"TAG_kUNDEF"];
}
